...
$(function()
{
    ...
    $('#bargeIn').click(function()
    {
		...
		{
			alert('Por favor insira um ramal de Administrador.');
		}
    });
...
function modify(camp)
{
	if ('<?php echo $campperms->campaign_update; ?>'!='N')
	{
		...
		alert('Erro: Você não tem permissão para modificar a campanha.');
	}
}
...
?>
    <ol id="joyRideTipContent">
      <li data-text="Next">
        <h2>Bem vindo ao VoIPai Dialer!</h2>
        <p>
           Isto ajudará você a navegar o sistema facilmente ou <a id="skipjoyride" onclick="skipjoyride()">Skip</a> Apenas navegue.
        </p>
      </li>
      <li data-class="wp-menu-image" data-button="Next" class="custom" data-options="tipLocation:left;">
        <h2>Menu de Aplicações</h2>
      ...
      <li data-id="payWithPayPalbalance" data-class="table-inside" data-button="Next" data-options="tipLocation:top;">
        ...
        <p>Clique <a target="_new" href=" http://goautodial.org/projects/goautodialce/wiki/Hosted_Howto_Load_Credits_30">here</a> para quanto deseja inserir de créditos.</p>
      </li> 
      <li data-id="table_agents" data-button="Next" data-options="tipLocation:right">
        <h2>Monitor/Barge</h2>
        <p>Clique <a target="_new" href="http://goautodial.org/projects/goautodialce/wiki/HowTo_Monitor_and_Barge_30">here</a> para monitorar os agentes em tempo real.</p>
      </li>
      <li data-id="callsTable" data-button="Next" data-options="tipLocation:left">
        <h2>Chamadas Ativas</h2>
        <p>Clique para ver as chamadas</p>
      </li>
      ...
      <li data-button="Close">
        <h2>É isso aí!</h2>
        <p>Para começar o mais rápido possível, consulte nossos tutoriais aqui:
           <a href="<http://goautodial.org/projects/goautodialce/wiki>" target="_new">Tutoriais</a><br/>
           <input type="checkbox" id="nextlog" name="nextlog" onclick="nextlog(this)"> Mostrar esta introdução novamente no próximo login?
        </p>
      </li>
				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div id="dashboard_todays_status" class="postbox">
						<div class="handlediv" title="Click to toggle"><br></div>
		    				...
		    				<!-- <div class="widgetconfig" title="switch"><a id="switch-to-inbound">Inbd</a></div> -->
                                                <h3 class="hndle">
							<span class="tdstats">Status de Hoje
					...
					?>
		    				...
		    				<div class="actiondiv" title="Refresh this widget" onclick='javascript:sippyreload()'><br></div>
                                                <h3 class="hndle">
                                                        <span class="tdstats">Informações da Conta
                                                                <span class="postbox-title-action">
                                                                </span>
                                                        </span>
                                                </h3>
					...
					<div id="dashboard_analytics" class="postbox ">
						<div class="handlediv" title="Click to toggle"><br></div>
		    				<div class="actiondiv" title="Refresh this widget" onclick='javascript:analyticsreload()'><br></div>
                                                <h3 class="hndle">
							<span class="tdstats">VoIPai Relatórios
								<span class="postbox-title-action">
									<!--<a href="?edit=dashboard_server_statistics#dashboard_server_statistics" class="edit-box open-box">Configure</a>-->
								</span>
							</span>
			...
			<div id="right-widget" class="postbox-container" style="width:49.5%;">
				<div class="meta-box-sortables ui-sortable">
					...
					<div id="dashboard_agents_status" class="postbox ">
						<div class="handlediv" title="Click to toggle"><br></div>
		    				<div class="actiondiv" title="Refresh this widget" onclick='javascript:agentsnleadsreload()'><br></div>
                                                <h3 class="hndle">
							<span class="tdstats">Status de Agentes e Contatos
								<span class="postbox-title-action">
					...
					<div id="agents_phones_logins" class="postbox ">
						...
						<h3 class="hndle">
							<span class="tdstats">Agentes e Ramais
								<span class="postbox-title-action">
					...
					<div id="dashboard_cluster_status" class="postbox " style="<?=$hideDiv ?>">
						<div class="handlediv" title="Click to toggle"><br></div>
		    				<div class="actiondiv" title="Refresh this widget" onclick='javascript:clustersreload()'><br></div>
                                                <h3 class="hndle">
							<span class="tdstats">Status do Cluster
								<span class="postbox-title-action">
									<!--<a href="?edit=dashboard_server_statistics#dashboard_server_statistics" class="edit-box open-box">Configure</a>-->
								</span>
							</span>
						...
						<div class="inside">
							...
							<div class="sub">Status do Cluster</div>
					...
					<div id="dashboard_server_statistics" class="postbox " style="<?=$hideDiv ?>">
						<div class="handlediv" title="Click to toggle"><br></div>
		    				<div class="actiondiv" title="Refresh this widget" onclick='javascript:serversreload()'><br></div>
                                                <h3 class="hndle">
							<span class="tdstats">Estatísticas do Servidor
								<span class="postbox-title-action">
									<!--<a href="?edit=dashboard_server_statistics#dashboard_server_statistics" class="edit-box open-box">Configure</a>-->
								</span>
							</span>
						...
						<div class="inside">
							...
							<div class="sub">Informações Vitais do Sistema</div>
							<div class="separate"></div>
							...
							<div class="sub">Utilização da Memória</div>
							<div class="separate"></div>
					...
					<div id="dashboard_controls" class="postbox " style="<?=$hideDiv ?>">
						<div class="handlediv" title="Click to toggle"><br></div>
		    				<div class="actiondiv" title="Refresh this widget" onclick='javascript:systemsreload()'><br></div>
                                                <h3 class="hndle">
							<span class="tdstats">Serviços do sistema
								<span class="postbox-title-action">
									<!--<a href="?edit=dashboard_agents_status#dashboard_agents_status" class="edit-box open-box">Configure</a>-->
								</span>
							</span>
						...
						<div class="inside">
							...
							<table style="width:100%" cellpadding=0 cellspacing=0>
								<tr style="font-weight:bold"><td>   SERVIÇO</td><td>STATUS</td><td style="width:10%;">AÇÃO</td></tr>
								<tr style="background-color:#E0F8E0">
									<td style="padding:5px 0 5px 20px;width:50%;border-top:#D0D0D0 dashed 1px;">Asterisk ( Telefonia )</td>
								...
								<tr style="background-color:#E0F8E0">
									<td style="padding:5px 0 5px 20px;width:50%;border-top:#D0D0D0 dashed 1px;">FTP ( Servidor de Arquivos )</td>
...
<div style="text-align:center;font-weight:bold;font-size:14px;">Monitoramento</div>
<br />
<input type="hidden" id="server_ip">
<input type="hidden" id="session_id">
<table id="test" border=0 cellpadding="3" cellspacing="3" style="width:100%;">
    <tr>
    	<td style="text-align:right;font-weight:bold;width:40%" nowrap>Operador:</td><td style="white-space:nowrap;">&nbsp;<span id="agent"></span></td>
    </tr>
    <tr>
    	<td style="text-align:right;font-weight:bold;" nowrap>Monitor:</td><td><select id="monitor" name="monitor"><option>OUVIR</option><option>ABRIR</option></select></td>
    </tr>
    <tr>
    	<td style="text-align:right;font-weight:bold;" nowrap>Ramal do Admin:</td><td><input type="text" id="phone" name="phone" value="<?php echo $phone_login; ?>" size="10" maxlength="15" /><!--<select id="phone" name="phone"><option><? echo $phone_login; ?></option></select>--></td>
    </tr>
    <tr>
...
<span id="orderByRealtime" style="display:none;">tempo</span>
<span id="realtimeInterval" style="display:none;">5</span>
<span id="toggleMonitoring" style="display:none;">operadores</span>
<span id="selectedCampaign" style="display:none;">TODOS</span>
<span id="selectedTenant" style="display:none;">TODOS</span>
</div>
</div>
<!-- Overlay for Barging/Listening -->
