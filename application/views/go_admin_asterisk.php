...
var quicktagsL10n = {
	...
	wordLookup: "Digite uma palavra para Pesquisar:",
	dictionaryLookup: "Pesquisa de dicionário",
	lookup: "pesquisa",
	closeAllOpenTags: "Fechar todas as tags abertas",
	closeTags: "fechar tags",
	enterURL: "Insira a URL",
	enterImageURL: "Insita a URL da imagem",
	enterImageDescription: "Insira uma descrição para a imagem"
};
...
<h1 id="site-heading" class="long-title">
	<a href="http://e3solutionsincph.com/" title="Visit Site">
		<span id="site-title">Painel do Administrador</span>
	</a>
</h1>
...
<div id="wphead-info">
<div id="user_info">
<p>Hello, <a href="" title="Edit your profile">admin</a> | <a href="../go_site/logout" title="Log Out">Sair</a></p>
</div>

<div id="favorite-actions"><div id="favorite-first"><a href="">Links Rápidos</a></div><div id="favorite-toggle"><br></div>
...
<div class="favorite-action"><a href="">VoIPai</a></div>
</div></div>
</div>
</div>
...
<ul id="adminmenu">
	...
	<div class="wp-menu-image"><a href="http://e3solutionsincph.com/wp-admin/index.php"><br></a></div><div class="wp-menu-toggle"><br></div><a href="http://e3solutionsincph.com/wp-admin/index.php" class="wp-first-item wp-has-submenu wp-has-current-submenu wp-menu-open menu-top menu-top-first menu-icon-dashboard menu-top-last" tabindex="1">Painel</a>
	<div class="wp-submenu"><div class="wp-submenu-head">Painel</div>
		<ul>
		<li class="wp-first-item current"><a href="http://e3solutionsincph.com/wp-admin/index.php" class="wp-first-item current" tabindex="1">Painel</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/update-core.php" tabindex="1">Atualizações<span class="update-plugins count-2" title="1 GoAutoDial Update, 1 Plugin Update"><span class="update-count">2</span></span></a>
		</li>
		</ul>
	</div>
	</li>
	...
	<a href="http://e3solutionsincph.com/wp-admin/edit.php" class="wp-has-submenu open-if-no-js menu-top menu-icon-post menu-top-first" tabindex="1">VoIPai Admin</a>
	<div class="wp-submenu"><div class="wp-submenu-head">VoIPai Admin</div>
		<ul>
		...
		<li><a href="http://e3solutionsincph.com/wp-admin/edit-tags.php?taxonomy=post_tag" tabindex="1">Sistema</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/edit-tags.php?taxonomy=post_tag" tabindex="1">Rede</a></li>
		</ul>
	</div>
	</li>
	...
	<div class="wp-submenu"><div class="wp-submenu-head">Vicidial Admin</div>
		<ul>
		<li class="wp-first-item"><a href="http://e3solutionsincph.com/wp-admin/upload.php" class="wp-first-item" tabindex="1">Usuários</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/media-new.php" tabindex="1">Campanhas</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/media-new.php" tabindex="1">Listas</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/media-new.php" tabindex="1">Scripts</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/media-new.php" tabindex="1">Grupos</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/media-new.php" tabindex="1">Operadores Remotos</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/media-new.php" tabindex="1">Ramais</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/media-new.php" tabindex="1">Servidores</a></li>
		</ul>
	</div>
	</li>
	...
	<div class="wp-submenu"><div class="wp-submenu-head">Links</div>
		...
		<li><a href="http://e3solutionsincph.com/wp-admin/link-add.php" tabindex="1">Adicionar Novo</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/edit-link-categories.php" tabindex="1">Categorias de Links</a></li>
		</ul>
	</div>
	</li>
	...
	<a href="http://e3solutionsincph.com/wp-admin/edit.php?post_type=page" class="wp-has-submenu menu-top menu-icon-page" tabindex="1">Páginas</a>
	<div class="wp-submenu"><div class="wp-submenu-head">Páginas</div>
		<ul>
		<li class="wp-first-item"><a href="http://e3solutionsincph.com/wp-admin/edit.php?post_type=page" class="wp-first-item" tabindex="1">Páginas</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/post-new.php?post_type=page" tabindex="1">Adicionar novo</a></li>
		</ul>
	</div>
	</li>
	...
	<a href="http://e3solutionsincph.com/wp-admin/edit-comments.php" class="menu-top menu-icon-comments menu-top-last" tabindex="1">Comentários <span id="awaiting-mod" class="count-0"><span class="pending-count">0</span></span></a>
	</li>
	...
	<div class="wp-menu-toggle"><br></div>
	<a href="http://e3solutionsincph.com/wp-admin/themes.php" class="wp-has-submenu menu-top menu-icon-appearance menu-top-first" tabindex="1">Aparência</a>
	<div class="wp-submenu">
		<div class="wp-submenu-head">Aparência</div>
		<ul>
		<li class="wp-first-item"><a href="http://e3solutionsincph.com/wp-admin/themes.php" class="wp-first-item" tabindex="1">Temas</a></li>
		...
		<li><a href="http://e3solutionsincph.com/wp-admin/themes.php?page=functions.php" tabindex="1">Opções Premium</a></li><li><a href="http://e3solutionsincph.com/wp-admin/theme-editor.php" tabindex="1">Editor</a></li>
		</ul>
        </div>
	</li>
	...
	<div class="wp-submenu"><div class="wp-submenu-head">Plugins <span class="update-plugins count-1"><span class="plugin-count">1</span></span></div>
		...
		<li><a href="http://e3solutionsincph.com/wp-admin/plugin-install.php" tabindex="1">Adicionar novo</a></li>
	...
	<div class="wp-menu-toggle"><br></div>
	<a href="http://e3solutionsincph.com/wp-admin/users.php" class="wp-has-submenu menu-top menu-icon-users" tabindex="1">Usuários</a>
	<div class="wp-submenu"><div class="wp-submenu-head">Usuários</div>
		<ul>
		<li class="wp-first-item"><a href="http://e3solutionsincph.com/wp-admin/users.php" class="wp-first-item" tabindex="1">Usuários</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/user-new.php" tabindex="1">Adicionar Novo</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/profile.php" tabindex="1">Seu Perfil</a></li>
		</ul>
	</div>
	</li>
	...
	<div class="wp-menu-toggle"><br></div>
	<a href="http://e3solutionsincph.com/wp-admin/tools.php" class="wp-has-submenu menu-top menu-icon-tools" tabindex="1">Ferramentas</a>
	<div class="wp-submenu"><div class="wp-submenu-head">Ferramentas</div>
		<ul>
		<li class="wp-first-item"><a href="http://e3solutionsincph.com/wp-admin/tools.php" class="wp-first-item" tabindex="1">Ferramentas</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/import.php" tabindex="1">Importar</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/export.php" tabindex="1">Exportar</a></li>
		</ul>
	</div>
	</li>
	...
	<div class="wp-menu-toggle"><br></div>
	<a href="http://e3solutionsincph.com/wp-admin/options-general.php" class="wp-has-submenu menu-top menu-icon-settings menu-top-last" tabindex="1">Configurações</a>
	<div class="wp-submenu">
        <div class="wp-submenu-head">Configurações</div>
		<ul>
		<li class="wp-first-item"><a href="http://e3solutionsincph.com/wp-admin/options-general.php" class="wp-first-item" tabindex="1">Geral</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/options-writing.php" tabindex="1">Escrevendo</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/options-reading.php" tabindex="1">Lendo</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/options-discussion.php" tabindex="1">Discussão</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/options-media.php" tabindex="1">Mídia</a></li>
		<li><a href="http://e3solutionsincph.com/wp-admin/options-privacy.php" tabindex="1">Privacidade</a></li>
...
<div style="display: none;" id="screen-options-wrap" class="hidden">
	<form id="adv-settings" action="" method="post">
			<h5>Mostrar na Tela</h5>
		<div class="metabox-prefs">
			<label for="dashboard_right_now-hide"><input class="hide-postbox-tog" name="dashboard_right_now-hide" id="dashboard_right_now-hide" value="dashboard_right_now" checked="checked" type="checkbox">Agora Mesmo</label>
<label for="dashboard_recent_comments-hide"><input class="hide-postbox-tog" name="dashboard_recent_comments-hide" id="dashboard_recent_comments-hide" value="dashboard_recent_comments" checked="checked" type="checkbox">Comentários Recentes <span class="postbox-title-action"><a href="http://e3solutionsincph.com/wp-admin/?edit=dashboard_recent_comments#dashboard_recent_comments" class="edit-box open-box">Configurar</a></span></label>
<label for="dashboard_incoming_links-hide"><input class="hide-postbox-tog" name="dashboard_incoming_links-hide" id="dashboard_incoming_links-hide" value="dashboard_incoming_links" checked="checked" type="checkbox">Links de Entrada <span class="postbox-title-action"><a href="http://e3solutionsincph.com/wp-admin/?edit=dashboard_incoming_links#dashboard_incoming_links" class="edit-box open-box">Configurar</a></span></label>
...
<label for="dashboard_recent_drafts-hide"><input class="hide-postbox-tog" name="dashboard_recent_drafts-hide" id="dashboard_recent_drafts-hide" value="dashboard_recent_drafts" checked="checked" type="checkbox">Rascunhos Recentes</label>
<label for="dashboard_primary-hide"><input class="hide-postbox-tog" name="dashboard_primary-hide" id="dashboard_primary-hide" value="dashboard_primary" checked="checked" type="checkbox">GoAutoDial Blog <span class="postbox-title-action"><a href="http://e3solutionsincph.com/wp-admin/?edit=dashboard_primary#dashboard_primary" class="edit-box open-box">Configurar</a></span></label>
<label for="dashboard_secondary-hide"><input class="hide-postbox-tog" name="dashboard_secondary-hide" id="dashboard_secondary-hide" value="dashboard_secondary" checked="checked" type="checkbox">Outras Notícias do GoAutoDial <span class="postbox-title-action"><a href="http://e3solutionsincph.com/wp-admin/?edit=dashboard_secondary#dashboard_secondary" class="edit-box open-box">Configurar</a></span></label>
			<br class="clear">
		</div>
		<h5>Layout da Tela</h5>
<div class="columns-prefs">Número de Colunas:
