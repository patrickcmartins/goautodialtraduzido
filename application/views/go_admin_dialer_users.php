<?php
########################################################################################################
####  Name:             	go_admin_dialer_users.php                                           ####
			...
			<form id="adv-settings" action="" method="post">
				...
				<label for="dashboard_server_statistics-hide">
					...
					Status do Servidor
						<span class="postbox-title-action">
							<a href="" class="edit-box open-box">Configurar</a>
						</span>
				</label>
				<label for="dashboard_agents_status-hide">
					...
					Status dos Operadores
						<span class="postbox-title-action">
							<a href="?edit=dashboard_agents_status#dashboard_agents_status" class="edit-box open-box">Configurar</a>
						</span>
				</label>
				...
				<label for="dashboard_goautodial_news-hide">
					...
					GoAutoDial News
						<span class="postbox-title-action">
							<a href="?edit=dashboard_goautodial_news#dashboard_goautodial_news" class="edit-box open-box">Configurar</a>
						</span>
				</label>
				<label for="dashboard_goautodial_forum-hide">
					...
					<span class="postbox-title-action">
						<a href="?edit=dashboard_goautodial_forum#dashboard_goautodial_forum" class="edit-box open-box">Configurar</a>
					</span>
				</label>
				<br class="clear">
				</div>
		...
		<div id="advanced-search-wrap" class="hidden">
			<div class="metabox-prefs">
				<form name="post" action="" method="post" id="advanced-search">
					<h3 id="content-label">Pesquisa Avançada</h3>
					<div>
						<b>Palavras: </b> <input name="tags_input" id="tags-input" size="100" tabindex="1" type="text">
					</div>
					<br>
					<div>
						<b>Opções: </b> 
						<a href="" id="add_image" class="thickbox" title="Ramal"><img src="<? echo base_url();?>img/media-button-image.gif" alt="Phone"></a>
						<a href="" id="add_video" class="thickbox" title="Contato"><img src="<? echo base_url();?>img/media-button-video.gif" alt="Lead"></a>
						<a href="" id="add_audio" class="thickbox" title="Disposição"><img src="<? echo base_url();?>img/media-button-music.gif" alt="Disposition"></a>
						<a href="" id="add_media" class="thickbox" title="Gravação"><img src="<? echo base_url();?>img/media-button-other.gif" alt="Recordings"></a>
						<a href="" id="add_media" class="thickbox" title="Tudo"><img src="<? echo base_url();?>img/media-button-other.gif" alt="All"></a>
					</div>
					<br>
						<b>Condições: </b>
					<div>
