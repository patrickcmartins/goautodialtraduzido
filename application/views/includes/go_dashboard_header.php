...
<div id="middle-head">
	...
	<div id="wphead-info" >
		<div id="user_info">
			<div>
				<a href="<? echo $home;?>"  style="color:#FFFFFF;text-decoration:none;" title="Go Back">Voltar</a>
			</div>
		</div>
	</div>
	<?
	...
	?>
			...
			<table id="test" border=0 cellpadding="3" cellspacing="3" style="width:100%;">
				<tr>
					<td style="text-align:right;font-weight:bold;width:40%" nowrap>ID Operador:</td><td>&nbsp;<span id="users_id_span"></span><input type="hidden" id="users_id" name="users_id" value="" /></td>
				</tr>
				<tr>
					<td style="text-align:right;font-weight:bold;" nowrap>Senha:</td><td><input type="text" id="users_pass" name="users_pass" value="" /></td>
				</tr>
				<tr>
					<td style="text-align:right;font-weight:bold;" nowrap>Nome Completo:</td><td><input type="text" id="users_full_name" name="users_full_name" value="" /></td>
				</tr>
				<tr>
					<td style="text-align:right;font-weight:bold;" nowrap>Ramal Login:</td><td><input type="text" id="users_phone_login" name="users_phone_login" value="" readonly="readonly" /></td>
				</tr>
				<tr>
					<td style="text-align:right;font-weight:bold;" nowrap>Ramal Senha:</td><td><input type="text" id="users_phone_pass" name="users_phone_pass" value="" /></td>
				</tr>
				<tr>
