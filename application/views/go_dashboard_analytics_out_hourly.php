<?php
########################################################################################################
####  Name:             	go_dashboard_analytics_out_hourly.php                     	    ####
...
write_file("$cwd/data/sph-out-hourly-$groupId.json",json_encode($json_sph));
?>

<p class="sub">Vendas Ativo / Hora (Hoje - 9:00 AM - 09:00 PM)</p>
...
//         }
	...
	$.ajax({
	    ...
	    // URL
	    //url: "<? echo $base; ?>data/sph-out-hourly-" + currentdate + ".json",
	    url: "<? echo $base; ?>data/sph-out-hourly-<? echo $groupId; ?>" + ".json",
	    method: 'GET',
	    dataType: 'json',
