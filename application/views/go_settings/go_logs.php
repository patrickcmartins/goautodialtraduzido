	...
	$('#search_list').bind("keydown keypress", function(event)
	{
		...
		if (event.which == 13 && event.type == "keydown") {
			...
			if (search.length > 2) {
				...
				alert("Por favor, digite ao menos 3 caracteres para pesquisar.");
			}
		}
	});
...
<div style="float: right;margin-top:15px;margin-right:25px;"><span id="showAllLists" style="display: none">[Limpar Pesquisa]</span>&nbsp;<?=form_input('search_list',null,'id="search_list" maxlength="100" placeholder="Search '.$bannertitle.'"') ?>&nbsp;<img src="<?=base_url()."img/spotlight-black.png"; ?>" id="search_list_button" style="cursor: pointer;" class="toolTip" title="Pesquisar por usuários / Endereços IP dentro dos logs do Administrador" /></div>
				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div id="account_info_status" class="postbox">
						...
						<div class="inside">
                            ...
                            <div style="margin:<?php echo (preg_match("/^Windows/",$userOS)) ? "-23px" : "-22px"; ?> 0px -2px -10px;" id="request_tab"><span id="showList" class="tabtoggle menuOn">Logs</span><span id="request" style="display:none;">Mostrar Lista</span></div>
