...
<table id="logsTable" class="tablesorter" style="width:100%;" cellpadding=0 cellspacing=0>
	<thead>
		<tr style="font-weight:bold;">
			...
			<th style="text-align: left;">&nbsp;ENDEREÇO IP</th>
	...
	if (count($admin_logs->result()) > 0) {
		...
		echo "<tr class='odd'>";
		echo "<td colspan='6' style='border-top:#D0D0D0 dashed 1px;color:red;text-align:center;font-weight:bold;'>&nbsp;Nenhum Log Encontrado.</td>";
		echo "</tr>";
	}
	?>
	</tbody>
