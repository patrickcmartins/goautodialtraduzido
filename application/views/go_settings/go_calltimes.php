...
<div style="float: right;margin-top:15px;margin-right:25px;"><span id="showAllLists" style="display: none">[Limpar Pesquisa]</span>&nbsp;<?=form_input('search_list',null,'id="search_list" maxlength="100" size="25" placeholder="Search '.$bannertitle.'"') ?>&nbsp;<img src="<?=base_url()."img/spotlight-black.png"; ?>" id="search_list_button" style="cursor: pointer;" /></div>
