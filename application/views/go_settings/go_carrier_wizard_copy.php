...
<div style="font-weight:bold;font-size:16px;color:#333;">Operadoras &raquo;Adicionar Nova Operadora</div>
	...
	<tr>
		...
		<td valign="top" style="padding-left:100px;">
                   <form id="copy_carrier" method="post">
                     <table width="100%">
                         <tr>
                             <td style="width: 100px;white-space: nowrap;"><strong>ID da Operadora:</strong></td><td><?=form_input('carrier_id',null,'id="carrier_id"')?> <span id="aloading"></span></td>
                         </tr>
                         <tr>
                             <td style="width: 100px;white-space: nowrap;"><strong>Nome da Operadora:</strong></td><td><?=form_input('carrier_name',null,'id="carrier_name"')?></td>
                         </tr>
                         <tr>
                             <td style="width: 100px;white-space: nowrap;"><strong>IP do Servidor:</strong></td><td><?=form_dropdown('server_ip',$server,null,'id="server_ip"')?></td>
                         </tr>
                         <tr>
                             <td style="width: 100px;white-space: nowrap;"><strong>Operadora de Origem:</strong></td><td><?=form_dropdown('source_id',$carriers,null,'id="source_id"')?></td>
                         </tr>
                     </table>
                   </form>
		</td>
...
<hr style="border:#DFDFDF 1px solid;" />
<span id="saveButtons"><span id="cancel" style="white-space: nowrap;">Cancelar</span> | <span id="submit" style="white-space: nowrap;">Confirmar</span></span>
