...
<head>
  <title>VoIPai - Discador Hospedado</title>
...
<div id="go_menu" class="img-grd-nologo" style="position:fixed;top: 0px;width:100%;padding:0px 0px 0px 0px;z-index:999999;">
    ...
    <tr><td></td></tr>
    	<tr>
			...
			<td><span class="go_menu_top" title="Pricing"><a href="<?=base_url()?>index.php/pricing/pricingpage" class="go_menu_list">Preço</a></span></td> 
			<td><span class="go_menu_top" title="FAQ"><a href="<?=base_url()?>index.php/faq/faqpage" class="go_menu_list">FAQ</a></span></td>   		
    		<td><span class="go_menu_top" title="Tutorials"><a href="<?=base_url()?>index.php/tutorials/tutorialspage" class="go_menu_list">Tutoriais</a></span></td>
		 <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                          
        ...
        <div id="panel" style="">
                <div class="content clearfix">
                       ...
                       <div class="left" style=" border-top: white 0px solid!important;">
                                <h1>Bem Vindo ao GoAutoDial Cloud</h1>
                                <h2>Portal</h2>
                                <p class="grey">Por favor, insira seu usuário e senha.</p>
                                <h2>Agent</h2>
                                <p class="grey">Por favor, insira seu usuário, senha e as credenciais da campanha.</p>
                        </div>
<!--
                        ...
                        <div class="left">
                                ...
                                <div id="loadingportal" style="display:none;">
                                        <label class="grey" for="notice">Carregando.. Por favor aguarde..</label>
                                </div>
                        </div>
                        </form>
                ...
                <form name="vicidial_form" id="vicidial_form" action="https://<?=$_SERVER['SERVER_NAME']?>/agent/agent.php" method="post" class="clearfix">
                        ...
                        <div class="left right">
                                        ...
                                        <label class="grey" for="campaign">Campanha:</label>
