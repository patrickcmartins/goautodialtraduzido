	...
	<tr>
		...
		<td valign="top" style="padding-left:50px;">
					...
					<?=form_hidden('conf_secret',$system_settings->default_phone_registration_password,'id="conf_secret"');?>
                     <table>
                         <tr>
                           <td style="text-align:right;"><strong>Ramais Adicionais:</strong></td><td><?=form_dropdown('addcountXXX',$phoneCount,null,'id="addcountXXX"');?><?=form_input('addcount','1','id="addcount" size="3" maxlength="3" style="display:none"');?></td>
                         </tr>
                         <tr style="display:none" class="hideThis">
                           <td style="text-align:right;"><strong>Senha Padrão:</strong></td><td><?=form_input('password',$system_settings->default_phone_login_password,'id="password" maxlength="10" size="12"');?></td>
                         </tr>
                         <tr>
                           <td style="text-align:right;"><strong>Começando em:</strong></td><td><?=form_input('start_exten',null,"id='start_exten' size='5'")?> <i style="font-size:8px;">ex. 8001</i></td>
                         </tr>
						<tr style="display:none" class="hideThis">
				...
				echo form_dropdown('protocol',$protocolArray,null,'id="protocol"');
			      ?>
						...
						<tr style="display:none" class="hideThis hidePrefix">
							...
							<td>
							<?=form_input('dial_prefix','9999','id="dial_prefix" maxlength="10" size="10"') ?>&nbsp;<font size="1" color="red">(apenas números)</font>&nbsp;
							</td>
						</tr>
						<tr style="display:none" class="hideThis">
							<td style="text-align:right;font-weight:bold;">
...
<hr style="border:#DFDFDF 1px solid;" />
<span id="saveButtons"><span id="submit" style="white-space: nowrap;">Próximo</span></span>
