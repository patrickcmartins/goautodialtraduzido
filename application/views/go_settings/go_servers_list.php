...
$(function()
{
	...
	$('li.go_action_submenu').click(function () {
		...
		else
		{
			...
			if (action == 'delete')
			{
				var what = confirm('Tem certeza que deseja deletar esse servidor '+s+'?');
				if (what)
				{
...
<table id="mainTable" class="tablesorter" style="width:100%;" cellpadding=0 cellspacing=0>
	<thead>
		<tr style="font-weight:bold;">
			<th style="white-space:nowrap">&nbsp;SERVIDOR ID</th>
