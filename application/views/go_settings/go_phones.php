...
{
	var answer = confirm("Tem certeza que deseja deletar "+phone+"?");
...
function changePage(pagenum)
{
	...
	$('#table_container').load('<? echo $base; ?>index.php/go_phones_ce/go_update_phone_list/page/'+pagenum+'/'+search);
}
</script>
				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div id="account_info_status" class="postbox">
						<div class="rightdiv toolTip" id="add_phone" title="Add New Phone">
                        	Adicionar Novo Ramal <img src="<?php echo $base; ?>img/cross.png" style="height:14px; vertical-align:middle;display:none;" />
						</div>
						<div class="hndle">
						...
						<div class="inside">
                            ...
                            <div style="margin:<?php echo (preg_match("/^Windows/",$userOS)) ? "-23px" : "-22px"; ?> 0px -2px -10px;" id="request_tab"><span id="showList" class="tabtoggle menuOn">Ramais</span><span id="request" style="display:none;">Mostrar Lista</span></div>
