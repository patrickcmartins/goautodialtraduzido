...
<table style="width:100%;">
	<tr>
		...
		<td valign="top" style="padding-left:150px;">
                       <label><strong>Tipo da Operadora:</strong><span> <?=form_dropdown('carrier_type',array('GOAUTODIAL'=>'GoAutoDial - JustGoVoIP','MANUAL'=>'Manual','COPY'=>'Copy Carrier'),null,'id="carrier_type"')?></span></label>
		</td>
	</tr>
</table>
<hr style="border:#DFDFDF 1px solid;" />
<span id="saveButtons"><span id="carrier" style="white-space: nowrap;">Próximo</span></span>
