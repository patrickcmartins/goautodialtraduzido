...
$(function()
{
	...
	}, ' <small style="color:red;">ENDEREÇO IP INVÁLIDO</small>');
...
<div style="font-weight:bold;font-size:16px;color:#333;">Servidor &raquo; Adicionar Novo Servidor</div>
            ...
            <span id="wizardContent" style="height:100px; padding-top:10px;">
                ...
                <table id="serverTable" style="width:100%;">
                    <tr>
                        ...
                        <label class="modify-value">Servidor ID:</label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;font-weight:bold;">
                        <label class="modify-value">Descrição do Servidor:</label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">Versão do Asterisk:</label>
                        </td>
                        <td>
