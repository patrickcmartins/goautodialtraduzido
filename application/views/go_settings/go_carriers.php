...
{
	var answer = confirm("Tem certeza que deseja deletar "+carrier+"?");
	...
	if (answer)
	{
            $.post(
                   ...
                   function(data){
                     if(data !== "proceed"){
                         if(confirm("Tem certeza que desejar deletar ?")){
                             if(data !== "0"){
                                 if(confirm("Você está completamente certo ? Este processo é IRREVERSÍVEL!")){
                                     data = "proceed";
                                 }else{
                                     return false;
                                 }
...
function changePage(pagenum)
{
	...
	$('#table_container').load('<? echo $base; ?>index.php/go_carriers_ce/go_update_carrier_list/search/'+pagenum+'/'+search);
}
</script>
				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div id="account_info_status" class="postbox">
						<div class="rightdiv toolTip" id="add_carrier" title="Add New Carrier">
                        	Adicionar Nova Operadora <img src="<?php echo $base; ?>img/cross.png" style="height:14px; vertical-align:middle;display:none;" />
						</div>
						<div class="hndle">
						...
						<div class="inside">
                            ...
                            <div style="margin:<?php echo (preg_match("/^Windows/",$userOS)) ? "-23px" : "-22px"; ?> 0px -2px -10px;" id="request_tab"><span id="showList" class="tabtoggle menuOn">Operadoras</span><span id="request" style="display:none;">Mostrar Lista</span></div>
...
<div id="box2">
<a id="closebox2" class="toolTip" title="FECHAR"></a>
...
<div id="wizardSpan" style="visibility:hidden">falso</div>
