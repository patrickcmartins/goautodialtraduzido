...
switch ($type)
{
	...
	default:
?>
<div align="center" style="font-weight:bold; color:#333; font-size:16px;">EDITAR SERVIDOR: <?php echo "{$server_info->server_id}"; ?></div>
<br />
...
<table id="test" border=0 cellpadding="3" cellspacing="3" style="width:95%; color:#000; margin-left:auto; margin-right:auto;">
	...
	<tr class="advance_settings" style="display: none;">
		<td style="text-align:right;width:40%;height:10px;">
		Senha do Arquivo de Configuração:
		</td>
		<td>
		<?=form_input('conf_secret',$server_info->conf_secret,'id="conf_secret" maxlength="20" size="20"') ?>
		&nbsp;<span id="testSpan"><small style="color:red">Fraco</small></span>
		</td>
	</tr>
	<tr class="advance_settings" style="display: none;">
		<td style="text-align:right;width:40%;height:10px;">
	...
	<tr class="advance_settings" style="display: none;">
		<td style="text-align:right;width:40%;height:10px;">
		Extensão de Discagem Automática:
		</td>
		<td>
	...
	<tr class="advance_settings" style="display: none;">
		<td style="text-align:right;width:40%;height:10px;">
		Registo de desempenho do sistema:
		</td>
		<td>
		<?php
	...
	<tr class="advance_settings" style="display: none;">
		<td style="text-align:right;width:40%;height:10px;">
		IP do Servidor de Gravação Alternativo:
		</td>
		<td>
	...
	<tr class="advance_settings" style="display: none;">
		...
		Entrada de Plano de Discagem Personalizada:
		</td>
	</tr>
	<tr class="advance_settings" style="display: none;">
...
<table border="0" cellpadding="3" cellspacing="3" style="width:95%; color:#000; margin-left:auto; margin-right:auto;">
	<tr>
		<td style="text-align:center;font-weight:bold;" colspan="2">TRONCOS PARA ESSE SERVIDOR</td>
	</tr>
</table>
<br />
<form>
...
<table border="0" cellpadding="3" cellspacing="3" style="width:95%; color:#000; margin-left:auto; margin-right:auto;">
	<tr>
		<td style="text-align:center;font-weight:bold;" colspan="2">ADICIONAR NOVO SERVIDOR DE GRAVAÇÕES</td>
	</tr>
	<tr>
	...
	<tr>
		<td style="text-align:right;width:40%;height:10px;">Campanha:</td>
		<td>
		<?php
	...
	<tr>
		<td style="text-align:center;" colspan="2"><span id="addTrunks" class="buttons">ADICIONAR TRONCOS</span></td>
	</tr>
</table>
</form>
</span>
<br style="font-size:9px;" />
<div id="carrier_list" style="float: left;padding-left: 20px;" class="buttons">+ OPERADORAS NESTE SERVIDOR</div>
<table id="carrier_list_table" cellpadding="0" cellspacing="0" style="width: 95%;margin-left: auto;margin-right: auto;display: none;">
	<thead>
		<tr>
			<th style="white-space: nowrap;font-weight: bold;padding: 3px;">OPERADORA ID</th>
			<th style="white-space: nowrap;font-weight: bold;padding: 3px;">NOME</th>
			<th style="white-space: nowrap;font-weight: bold;padding: 3px;">REGISTRO</th>
			<th style="white-space: nowrap;font-weight: bold;padding: 3px;">ATIVO</th>
		</tr>
	</thead>
	<tbody>
<?php
...
<br />
<div id="phone_list" style="float: left;padding-left: 20px;" class="buttons">+ RAMAIS NESTE SERVIDOR</div>
<table id="phone_list_table" cellpadding="0" cellspacing="0" style="width: 95%;margin-left: auto;margin-right: auto;display: none;">
	<thead>
		<tr>
			<th style="white-space: nowrap;font-weight: bold;">RAMAL</th>
			<th style="white-space: nowrap;font-weight: bold;">NOME</th>
			<th style="white-space: nowrap;font-weight: bold;">ATIVO</th>
		</tr>
	</thead>
	<tbody>
<?php
...
<br />
<div id="conference_list" style="float: left;padding-left: 20px;" class="buttons">+ CONFERENCIAS NESTE SERVIDOR</div>
<table id="conference_list_table" cellpadding="0" cellspacing="0" style="width: 95%;margin-left: auto;margin-right: auto;display: none;">
	<thead>
		<tr>
			<th style="white-space: nowrap;font-weight: bold;">CONFERENCIA</th>
			<th style="white-space: nowrap;font-weight: bold;">RAMAL</th>
		</tr>
	</thead>
	<tbody>
