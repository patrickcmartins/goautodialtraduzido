...
<div align="center" style="font-weight:bold; color:#333; font-size:16px;">EDITAR MÚSICA DE ESPERA: <?php echo $moh_info->moh_id; ?></div>
<br />
...
<table id="test" border=0 cellpadding="3" cellspacing="3" style="width:90%; color:#000; margin-left:auto; margin-right:auto;">
	<tr>
    	<td style="text-align:right;" nowrap>Nome da Música de Espera:</td><td><?=form_input('moh_name',$moh_info->moh_name,'size="50" maxlength="100"') ?></td>
    </tr>
	<tr>
	...
	<tr style="<?php echo $hideFromTenant; ?>">
    	<td style="text-align:right;" nowrap>Grupo de Usuário:</td><td><?=form_dropdown('user_group',$user_group_array,$moh_info->user_group) ?></td>
    </tr>
	<tr>
    	<td style="text-align:right;" nowrap>Ordem Aleatória:</td><td><?=form_dropdown('random',array('N'=>'No','Y'=>'Yes'),$moh_info->random) ?></td>
    </tr>
	<tr>
    	<td>&nbsp;</td><td>&nbsp;</td>
    </tr>
	<tr>
		...
		<table border=0 cellpadding="0" cellspacing="0" style="width:70%; color:#000; margin-left:auto; margin-right:auto;">
			<tr>
				...
				<td style="font-weight: bold; width: 60px;">AÇÃO</td>
			</tr>
			<?php
			$x = 0;
			$k = 1;
			...
			<tr>
				<td colspan="3" style="white-space:nowrap;text-align:center;">Adicionar um arquivo de áudio: <?php echo form_dropdown('filename',$moh_audio_list,null,'id="filename" style="width:300px;"'); ?></td>
			</tr>
		</table>
	</td>
    </tr>
	...
	<tr>
    	<td>&nbsp;</td><td style="text-align:right;"><span id="saveSettings" class="buttons">SALVAR CONFIGURAÇÕES</span><!--<input id="saveSettings" type="submit" value=" SAVE SETTINGS " style="cursor:pointer;" />--></td>
    </tr>
</table>
</form>
