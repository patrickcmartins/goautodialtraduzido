                         ...
                         $.post(
                                ...
                                function(data){
                                     if(data.indexOf("Success") !== -1){
                                          alert("Sucesso: Ramal Salvo");
                                          location.reload();
                                     }else if(data.indexOf("Error") !== -1){
                                          alert("Errr: Erroao salvar Ramal");
                                     }
                                }
                         );
                     }
            ...
            $("#phoneForm > table").find("input").each(function(){
                if($(this).parent().parent().css("display") !== "none"){
                   if($(this).attr('id').indexOf("pass") !== -1){
                       $(this).rules("add",{required:true,minlength:2,messages:{required:"* Obrigatório",minlength:"Mínimo 2 Caracteres"}});
                   }else{
                       if($(this).attr('id').indexOf("extension") !== -1){
                           $(this).rules("add",{required:true,minlength:2,number:true,checkphones:true,messages:{required:"* Obrigatório",minlength:"Mínimo 2 Caracteres"}});
                       }else{
                           $(this).rules("add",{required:true,minlength:2,number:true,messages:{required:"* Obrigatório",minlength:"Mínimo 2 Caracteres"}});
                       }
                   }
                }
            });
...
<div style="font-weight:bold;font-size:16px;color:#333;">Ramal &raquo; Adicionar novo Ramal</div>
		...
		<input type="hidden" name="old_messages_<?=$key?>" value="0" />
                <table id="phoneTable" style="width:100%;">
                    <tr>
                        ...
                        <label class="modify-value">Ramal/Login:</label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <label class="modify-value">Senha do Login:</label>
                        </td>
                        <td>
                    ...
                    <tr class="advance_settings" style="display:none">
                        ...
                        <label class="modify-value">Senha de Registro:</label>
                        </td>
                        <td>
                    ...
                    <tr <?=($gens["protocol_$key"]=="EXTERNAL") ? "" : 'style="display:none"'; ?>>
                        <td style="text-align:right;width:30%;height:10px;font-weight:bold;">
                        <label class="modify-value">Prefixo de Discagem:</label>
                        </td>
                        <td>
						<?php
                    ...
                    <tr style="display:none;">
                        <td style="text-align:right;width:30%;height:10px;font-weight:bold;">
                        <label class="modify-value">Número no Plano de Discagem:</label>
                        </td>
                        <td>
                    ...
                    <tr style="display:none;">
                        <td style="text-align:right;width:30%;height:10px;font-weight:bold;">
                        <label class="modify-value">Voicemail:</label>
                        </td>
                        <td>
                    ...
                    <tr style="display:none;">
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">Caller ID de Saída:</label>
                        </td>
                        <td>
                        <?=form_input('outbound_cid_'.$key,null,'id="outbound_cid_'.$key.'" maxlength="20" size="15"') ?>&nbsp;<font size="1" color="red">(apenas números)</font>&nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">Grupo de Usuário:</label>
                        </td>
                        <td>
                        <?php
                    ...
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">IP do Servidor:</label>
                        </td>
                        <td>
                        <?php
						$serverArray = array();
                    ...
                    <tr style="display:none;">
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">Conta Ativa:</label>
                        </td>
                        <td>
                        <?php
                    ...
                    <tr style="display: none;">
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">Tipo de Ramal:</label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">Nome Completo:</label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">Protocolo:</label>
                        </td>
                        <td>
                        <?php
                    ...
                    <tr>
                        <td style="text-align:right;width:30%;height:10px;">
                        <label class="modify-value">Fuso Horário:</label>
                        </td>
                        <td>
                        <?php
						$gmtArray = array(
...
<hr style="border:#DFDFDF 1px solid;" />
<span id="saveButtons"><span id="cancel" style="white-space: nowrap;">Voltar</span> | <span id="submit" style="white-space: nowrap;">Confirmar</span></span>
