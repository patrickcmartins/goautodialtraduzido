...
<form  method="POST" id="edit_go_listfrm" name="edit_go_listfrm">
    ...
    <table class="tableedit">
            ...
            <tr>
                <td><label class="modify-value">Substituição do Script do Operador:</label> </td>
                <td>
            ...
            <tr>
                <td colspan="2">
                <label class="modify-value">Número 1:</label> <input type="text" name="xferconf_a_number" id="xfer1" size="20" maxlength="50" value="<?php echo $listid->xferconf_a_number; ?>">
                <label class="modify-value">Número 4:</label> <input type="text" name="xferconf_d_number" id="xfer4" size="20" maxlength="50" value="<?php echo $listid->xferconf_d_number; ?>">
                <br>
                <label class="modify-value">Número 2:</label> <input type="text" name="xferconf_b_number" id="xfer2" size="20" maxlength="50" value="<?php echo $listid->xferconf_b_number; ?>">
                <label class="modify-value">Número 5:</label> <input type="text" name="xferconf_e_number" id="xfer5" size="20" maxlength="50" value="<?php echo $listid->xferconf_e_number; ?>">
                <br>
                <label class="modify-value">Número 3:</label> <input type="text" name="xferconf_c_number" id="xfer3" size="20" maxlength="50" value="<?php echo $listid->xferconf_c_number; ?>">
                </td>
            </tr>
            ...
            <tr>
				...
				<br />
				<div id="statuses_within_list" style="cursor:pointer;"><pre style="display:inline;">[+]</pre> STATUS DESSA LISTA</div>
