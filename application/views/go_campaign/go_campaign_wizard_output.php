...
?>
            ...
            <table style="width:100%;">
                ...
                <tr>
                 ...
                 <tr>
                    <td class="label">Checar Duplicados:</td>
                    <td>
                 ...
                 <tr>
                    ...
                    <td></td>
                    <td>
                            <input type="button" value="CARREGAR CONTATOS" name="submit_file" id="submit_file" style="cursor:pointer;">
                    </td>
...
?>
                ...
                <tr>
                	<td class="label">Menu de Chamada:</td>
                    <td>
			<?php
			$callMenuArray[''] = "---NONE---";
			...
			?>
            	...
            	<tr class="advanced">
                	<td class="label">Pressione 3, Audio:</td>
            	...
            	<tr class="advanced">
                	<td class="label">Pressione 3 Status:</td>
            	...
            	<tr class="advanced">
                	<td class="label">Pressione 3 DID:</td>
            	...
            	<tr class="advanced">
                	<td class="label">Pressione 4 Status:</td>
            	...
            	<tr class="advanced">
                	<td class="label">Pressione 4 DID:</td>
...
?>
                <tr>
					<td colspan="2" style="text-align:right;"><span id="showAdvance">Configurações Avançadas</span></td>
                </tr>
<?php
			}
?>
