...
$(function()
{
	...
	$('#campaign_name').keyup(function(e)
	{
		...
		{
			alert('Nome da campanha não pode estar vazio.');
		}
	});
...
<div id="campTitle" style="font-weight:bold;font-size:16px;color:#333;">Campanha &raquo; Saída</div>
                ...
                <table id="campTable" style="width:100%;">
                    ...
                    <tr class="survey" style="display:none;">
                        ...
                        <select id="survey_type">
                            <option value="BROADCAST">BROADCAST DE VOZ</option>
                            <option value="PRESS1">PESQUISA PRESSIONE 1</option>
                        </select>
                        </td>
                    </tr>
                    <tr class="survey" style="display:none;">
...
<hr style="border:#DFDFDF 1px solid;" />
<span id="saveButtons"><span id="back" style="display:none;white-space: nowrap;">Voltar</span><span id="back_pipe" style="display:none;white-space: nowrap;"> | </span><span id="next" style="white-space: nowrap;">Próximo</span><span id="modify_pipe" style="display:none;white-space: nowrap;"> | </span><span id="modify" style="display:none;white-space: nowrap;">Editar</span></span>
