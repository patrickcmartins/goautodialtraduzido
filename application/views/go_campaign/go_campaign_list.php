...
<table id="mainTable" class="tablesorter" border="0" cellpadding="1" cellspacing="0" style="width:100%;">
	<thead>
        <tr style="font-weight:bold;">
            ...
            <th style="display:none;">&nbsp;&nbsp;STATUS DO AGENTE REMOTO</th>
            <th colspan="3" style="width:6%;text-align:center;" nowrap>
		<span style="cursor:pointer;" id="selectAction">&nbsp;AÇÃO &nbsp;<img src="<?php echo $base; ?>img/arrow_down.png" />&nbsp;</span></th>
...
<?php
	if (count($campaign['list']) > 0) {
		...
		foreach ($campaign['list'] as $row)
		{
			...
			echo "<td style=\"border-top:#D0D0D0 dashed 1px;\">&nbsp;&nbsp;<span onclick=\"modify('".$row->campaign_id."')\" style=\"cursor:pointer;\" class=\"toolTip hoverCampID\" title=\"EDITAR CAMPANHA<br />".$row->campaign_id."\">".$row->campaign_id."</span></td>\n";
			echo "<td style=\"border-top:#D0D0D0 dashed 1px;\">&nbsp;&nbsp;<span onclick=\"modify('".$row->campaign_id."')\" style=\"cursor:pointer;\" class=\"toolTip hoverCampID\" title=\"EDITAR CAMPANHA<br />".$row->campaign_id."\">".str_replace("-","&#150;",$row->campaign_name)."</span></td>\n";
...
<table id="leadRecyclingTable" class="tablesorter" border="0" cellpadding="1" cellspacing="0" style="width:100%;">
	<thead>
        <tr style="font-weight:bold;">
            ...
            <th style="width:6%;text-align:center;" colspan="3" nowrap><span style="cursor:pointer;" id="selectRecycleAction">&nbsp;AÇÃO &nbsp;<img src="<?php echo $base; ?>img/arrow_down.png" />&nbsp;</span></th>
...
<table id="pauseCodeTable" class="tablesorter" border="0" cellpadding="1" cellspacing="0" style="width:100%;">
	<thead>
        <tr style="font-weight:bold;">
            ...
            <!--<th>&nbsp;&nbsp;ATTEMPT DELAY</th>-->
            <!--<th>&nbsp;&nbsp;MAXIMUM ATTEMPTS</th>-->
            <th style="width:6%;text-align:center;" colspan="3" nowrap><span style="cursor:pointer;" id="selectPauseCodeAction">&nbsp;AÇÃO &nbsp;<img src="<?php echo $base; ?>img/arrow_down.png" />&nbsp;</span></th>
...
<table id="hotKeysTable" class="tablesorter" border="0" cellpadding="1" cellspacing="0" style="width:100%;">
	<thead>
        <tr style="font-weight:bold;">
            ...
            <!--<th>&nbsp;&nbsp;ATTEMPT DELAY</th>-->
            <!--<th>&nbsp;&nbsp;MAXIMUM ATTEMPTS</th>-->
            <th style="width:6%;text-align:center;" colspan="3" nowrap><span style="cursor:pointer;" id="selectHotKeysAction">&nbsp;AÇÃO &nbsp;<img src="<?php echo $base; ?>img/arrow_down.png" />&nbsp;</span></th>
...
<div id="boxStatus">
<a id="closeboxStatus" class="toolTip" title="FECHAR"></a>
<div id="overlayContentStatus">
	...
	<table style="width:90%" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td style="white-space:nowrap;">
				<select style="width:250px;font-size:12px;" id="statusCampID" name="statusCampID" onchange="javascript:checkStatus();">
					<option value="ALLCAMP">--- TODAS CAMPANHAS ---</option>
					<?php
		...
		<tr>
			<td align="right"><label class="modify-value">Selecionável:&nbsp;&nbsp;&nbsp;</label></td>
		...
		<tr>
			<td align="right"><label class="modify-value">Venda:&nbsp;&nbsp;&nbsp;</label></td>
		...
		<tr>
			<td align="right"><label class="modify-value">Não Interessado:&nbsp;&nbsp;&nbsp;</label></td>
		...
		<tr>
			<td align="right"><label class="modify-value">Intrabalhável:&nbsp;&nbsp;&nbsp;</label></td>
...
<div id="overlayContentPauseCodes">
	...
	<table style="width:90%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td align="right"><label class="modify-value">Código de Pausa:&nbsp;&nbsp;&nbsp;</label></td>
			<td style="white-space:nowrap;">
		...
		<tr>
			<td align="right"><label class="modify-value">Nome do Código de Pausa:&nbsp;&nbsp;&nbsp;</label></td>
		...
		<tr>
			<td align="right"><label class="modify-value">Cobrável:&nbsp;&nbsp;&nbsp;</label></td>
			<td style="white-space:nowrap;">
...
<div id="overlayContentFilters">
	...
	<table id="filters1stTable" style="width:90%" cellpadding="0" cellspacing="0">
		<tr>
			<td align="right"><label class="modify-value">Filtro ID:&nbsp;&nbsp;&nbsp;</label></td>
			<td style="white-space:nowrap;">
	...
	<table id="filters2ndTable" style="width:90%;display:none;" cellpadding="0" cellspacing="0">
		<tr>
			<td align="right"><label class="modify-value">Campos:&nbsp;&nbsp;&nbsp;</label></td>
			<td style="white-space:nowrap;">
