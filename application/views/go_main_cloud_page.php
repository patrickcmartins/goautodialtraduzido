            ...
            <div id="header">
                ...
                <div class="head-row1">
                    <div class="col1">
                            ...
                            <h1 class="site-name"><a href="#" title="Home">VoIPai - Dialer</a></h1>
                    </div>
                    <div class="col2">
            ...
            <div id="productsandservices" class="yuimenubar yuimenubarnav">
              ...
              <div class="bd">
                <ul  style="text-decoration:none" class="first-of-type">
                      ...
                      <li  class="yuimenubaritem"><a href="/agent" class="yuimenubaritemlabel" >Operador</a></li>
                      <li  class="yuimenubaritem"><a href="#?w=280" class="yuimenubaritemlabel" rel="popup1">Supervisor</a></li>
                      <li  class="yuimenubaritem"><a href="/portal" class="yuimenubaritemlabel">Inscrever-se</a></li>
                      <li  class="yuimenubaritem"><a href="#" class="yuimenubaritemlabel">Sobre nós</a></li>
               </ul>
          </div>
       </div>                                             </div>
                    <div class="col3">
...
<div class="ind">
    ...
    <div class="content">
		<p><strong>VoIPai</strong> é um sistema de discador preditivo de nível empresarial. Ele contém todos os componentes de um sistema totalmente funcional de discador preditivo.<br />
	&nbsp;<br />
	<strong>VoIPai</strong> é totalmente baseado em web. Tudo é feito dentro de seu navegador de web, desde administração de banco de dados, discador e configuração de PABX - tudo em um.<br />
