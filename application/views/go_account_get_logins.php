...
<p class="sub">Operadores</p>
<table>
	<tbody>
	<tr class="first">
			<td class="b disableLink"><a class="" style="cursor:pointer"><? echo $num_seats; ?></a></td>
			<td class="t bold disableLink"><a class="" style="cursor:pointer">Número de Operadores</a></td>
	</tr>
	</tbody>
</table>
<?
...
<p class="sub">Recursos da URL</p>
<table>
	<tbody>
	<tr class="first">
			<td class="t pbold disableLink"><a class="" style="cursor:pointer">Login de Operador:</a>&nbsp;</td>
			<td class="t"><a class="" href="https://<?=$_SERVER[HTTP_HOST]?>/agent/agent.php" target="_new">https://<?=$_SERVER[HTTP_HOST]?>/agent/agent.php</a></td>
	</tr>
	<tr>
			<td class="t pbold disableLink"><a class="" style="cursor:pointer">SIP/Domínio:</a>&nbsp;</td>
...
<table id='agents_list'>
	<tbody>
	<tr class="first">
			<td class="f bold disableLink"><a class="" style="cursor:pointer">Usuário</a></td>
			<td class="f bold disableLink"><a class="" style="cursor:pointer">Senha</a> <span id="showAgentPass" class="toolTip" title="Mostrar/Esconder as senhas" style="cursor:pointer;font-size:10px;">[mostrar]</span></td>
	</tr>
<?
...
<table id='phones_list'>
	...
	<tr class="first">
			...
			<td class="f bold disableLink"><a class="" style="cursor:pointer">Senha</a> <span id="showPhonePass" class="toolTip" title="Mostrar/Esconder as senhas" style="cursor:pointer;font-size:10px;">[mostrar]</span></td>
	</tr>
<?
if ($go_get_datacount>0) {
	$i=0;
...
<table>
	<tbody>
		...
		<tr>
		 ...
		 <td class='dp'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</td>
		 <td class='showhide'>
		 <a id='showmemore_logins' class='showmore' onclick='javascript:showmemorelogins()'>&nbsp;&raquo; Clique aqui para mostrar mais... </a>
		 <a style='display: none' id='hidemore_logins' class='hidemore'>&nbsp;&raquo; Clique para esconder... </a>
