			...
			?>
                        ...
                        <h3 class="hndle">
                            ...
                            <div id="tab-nav" class="tab-nav">
                                <ul>
                                    <li><a href="<?=$base_path?>index.php/go_user_ce/index/<?=$user_group?>/<?=$page?>"><span>Usuários</span></a></li>
...
<div class="overlay-leadinfo"></div>
    <div class="wizard-box">
        ...
        <div class="wizard-action">
              <a onclick="cancelWizard(this)">Cancelar</a>&nbsp;|&nbsp;
...
<div class="overlay-modify">
    ...
    <div class="wizard-box-modify">
        ...
        <?=form_open(null,'id="form" class="edit-user"');?>
            ...
            <div class="boxleftside boxleftside-modify">Senha do Ramal:</div>
	...
	//       }
	    ...
	    ?>
            <div class="boxleftside boxleftside-modify" <?=$hideLevels?>>Nível do Usuário:</div>
        ...
        <div class="quick-action-set">
            <a id="actions-update">Atualizar</a> 
        </div>
        <br class="clear"/>
    </div>
    ...
    <div class="user-cornerall wizard-box-info">
         ...
         <div class="datepicker-container">
              <div class="hovermenu" id="widgetField">
                    ...
                    <a href="javascript:void(0);" id="daterange">Selecionar Data</a>
              </div>
         ...
         <br class="clear"/>
         <div id="<?=$userinfo[0]->user?>" class="emergency-container"><a href="javascript:void(0);" class="emergency">Forçar Logout</a></div>
         <br class="clear"/>
    </div>
         <div class="agent-loginlogout-time user-cornerall">
              ...
              <div class="time-loginlogout-tbl">
                   ...
                   <div class="pager-container agent-loginlogout-pager">
                       ...
                       <span class="pager-perpage"><?=form_dropdown('page-dropdown',array(25=>25,50=>50,100=>100,"all"=>"All"))?>&nbsp;por página</span>
         ...
         <div class="leadinfo user-cornerall">
              ...
              <div class="leadinfolabel">Comentário</div>
