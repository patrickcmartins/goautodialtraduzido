...
<p class="sub">Status dos Contatos</p> 							
<table>
	<tbody>
	<tr class="first">
	...
	<tr>
			...
			<td class="r "><a class="cur_hand">Total de Contatos Ativos</a></td>
	</tr>
	</tbody>
</table>

<br /><br />
<p class="subs">Status das Campanhas</p>
...
<br><br><br>
	...
	if ($item->mycnt > 0) {
	echo "<td class='dp campTDs'><div class='tdcon3'><div class='tdcon4'><a style='cursor:pointer;' class='disableLink toolTip' onclick=\"modify('".$item->campaign_id."')\" title='ID da Camapanha: $camp'>".$item->campaign_name."</a></div></div></td>";
	echo "<td class='r'>Tem <b style='font-size: 16px;'><</b> 100 contatos</a></td>";
	}
	else{
	echo "<td class='dr campTDs'><div class='tdcon3'><div class='tdcon4'><a style='cursor:pointer' class='disableLink toolTip' onclick=\"modify('".$item->campaign_id."')\" title='ID da Camapanha: $camp'>".$item->campaign_name."</a></div></div></td>";
	echo "<td class='r'>Não tem contatos</a></td>";	
	}
	echo "</tr>\n";
...
<table>
	<tbody>
		...
		<tr>
		 ...
		 <td class='dp'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
		 <td class='showhide'>
		 <a id='showmemore' class='showmore' onclick='javascript:showmemore()'>&nbsp;&raquo; Clique para ver mais... </a>
		 <a style='display: none' id='hidemore' class='hidemore'>&nbsp;&raquo; Clique para esconder... </a>
