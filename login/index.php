...
<html>
<head>
<title><? echo "VoiPai"; ?> - Capacitando a Próxima Geração de CallCenters</title>
...
<body class="bodybgback">
	...
	<div class="bodyheader" style="line-height:16px;">
		 ...
		 <span style="margin-right: 1%; font-size: 13px; margin-top: 8px; float: right;">
				<a href="http://<?=$_SERVER['SERVER_NAME']?>/agent/" class="go_menu_list" style="color:#FFFFFF;text-decoration:none;"><b>Login de Operador</b></a>
		 </span>
	</div>
<br><br><br><br>
<center>
							...
							<tr>
								<td align="left"><font size="1"> &nbsp; </font></td>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td align="center">
                                                                        <font color="black">Número da Conta / Web Login:</a>
                                                                </td>
                                                        </tr>
                                                        <tr>
                                                                <td align="center">
						...
						<table width="400px" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td align="left" style="padding-left:35px;">
									<font color="black">Login Administrador:</font>
								</td>
							</tr>
							<tr>
								<td align="center">
...
?>
 ...
 <div class='footer'>
   <table width="100%" >
				<tr><td align="center" style="color: #6a6363; font-size: 10px;">VoIPai 3.0 <a href='../gplv2'>GPLv2</a></td></tr>
				
            			<tr><td align="center" style="color: #6a6363; font-size: 10px;">&copy; VoIPai Telecom. 2017 All Rights Reserved.</td></tr>
    </table>
